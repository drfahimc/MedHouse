...
class SubjectListWidget extends StatefulWidget {
  ...
  static String routeName = 'SubjectList';
  static String routePath = '/subjectList';
...
class _SubjectListWidgetState extends State<SubjectListWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SubjectListModel());
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            context.pushNamed(
                              PathologyTopicDrBhaWidget.routeName,
