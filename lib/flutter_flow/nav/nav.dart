...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: SubjectListWidget.routeName,
          path: SubjectListWidget.routePath,
          builder: (context, params) => SubjectListWidget(),
        ),
        FFRoute(
          name: PathologyTopicDrBhaWidget.routeName,
          path: PathologyTopicDrBhaWidget.routePath,
